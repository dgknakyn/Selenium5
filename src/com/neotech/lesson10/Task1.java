...
public class Task1 extends BaseClass {
	...
	public static void main(String[] args) throws InterruptedException {
		 ...
		 * (Up-Right next to Help) Select from June 6, 2023 to July 15, 2023 Click on
...
//
		...
		// click on July
		driver.findElement(By.xpath("//*[@id='DisciplinaryCaseSearch_createdDateFrom_root']//li/span[text()='July']"))
				.click();

		List<WebElement> dates = driver
				.findElements(By.xpath("//*[@id='DisciplinaryCaseSearch_createdDateFrom_table']/tbody/tr/td"));
		...
		// click august
		driver.findElement(By.xpath("//*[@id=\"DisciplinaryCaseSearch_createdDateTo_root\"]//li/span[text()='August']"))
				.click();

		List<WebElement> dates2 = driver
				.findElements(By.xpath("//*[@id=\"DisciplinaryCaseSearch_createdDateTo_table\"]/tbody/tr/td"));
